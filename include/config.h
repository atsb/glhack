...
/* The GL3D interface shares a lot of code with the normal GL (2D)
 * interface, and cannot be enabled independently.
 */
#if defined(GL3D_GRAPHICS) && ! defined(GL_GRAPHICS)
#define GL_GRAPHICS
#endif
 ...
 *
 *	tty, X11, mac, amii, BeOS, Qt, Gem, Gnome, GL, GL3D, SDL
 */
...
#ifdef GL3D_GRAPHICS
# ifndef DEFAULT_WINDOW_SYS
#  define DEFAULT_WINDOW_SYS "GL3D"
# endif
#endif
...
#define AUTO_OPEN	/* open doors by walking into them */
/* difficulty */
